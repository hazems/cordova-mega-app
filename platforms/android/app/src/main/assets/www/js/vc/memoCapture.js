(function() {
    ...
    $(document).on("pageinit", "#memoCapture", function(e) {
        ...
        $("#playVoice").on("vclick", function(e) {
            e.preventDefault();
        ...
        $("#photoFromGallery").on("vclick", function(e) {
            e.preventDefault();
        ...
        $("#photoFromCamera").on("vclick", function(e) {
            e.preventDefault();
            $("#photoTypeSelection").popup("close");
